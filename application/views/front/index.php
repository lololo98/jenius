...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('/assets/front/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css') ?>">
...
<body>
    <div class="super_container">
        ...
        <header class="header d-flex flex-row">
            ...
            <div class="header_side d-flex flex-row justify-content-center align-items-center">
                <img src="<?= base_url('assets/front/images/phone-call.svg') ?>" alt="">
        ...
        <!-- Home -->
        <?php $this->load->view('front/page/'.$halaman) ?>
        <!-- Footer -->
        <footer class="footer">
            <div class="container">
                <!-- Footer Content -->
                                ...
                                <ul>
                                    <li class="footer_contact_item">
                                        <div class="footer_contact_icon">
                                            <img src="<?= base_url('assets/front/images/placeholder.svg') ?>" alt="https://www.flaticon.com/authors/lucy-g">
                                        </div>
                                        Surabaya,TMB Street no 89
                                    </li>
                                    <li class="footer_contact_item">
                                        <div class="footer_contact_icon">
                                            <img src="<?= base_url('assets/front/images/smartphone.svg') ?>" alt="https://www.flaticon.com/authors/lucy-g">
                                        </div>
                                        081332262686
                                    </li>
                                    <li class="footer_contact_item">
                                        <div class="footer_contact_icon">
                                            <img src="<?= base_url('assets/front/images/envelope.svg') ?>" alt="https://www.flaticon.com/authors/lucy-g">
    ...
    <script src="<?= base_url('assets/front/plugins/scrollTo/jquery.scrollTo.min.js') ?>"></script>
